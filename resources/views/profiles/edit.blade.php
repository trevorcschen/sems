...
@section('subheader-link', route('profiles.show'))
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Update Profile Info
                    ...
                    <div class="kt-portlet__body">
                        <form class="kt-form" id="profile-form" action="{{ route('profiles.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    ...
                                                    <span class="form-text text-muted">
                                                        Leave this blank if you do not wish to change the profile image.
                                                    </span>
